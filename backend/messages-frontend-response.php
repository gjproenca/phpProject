...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if ($conn->connect_error) {
        ...
        if (isset($_GET['messageUserId'])) {
            $sqlDeleteUpload = "UPDATE `messagefrontend` SET `Active` = 0 WHERE `messageUserId` = $messageUserId";
        }
                ...
                <div class="p-5 card text-white bg-primary border-secondary">
                    <div class="card-body">
                        ...
                        <form method="POST" action="">
                            ...
                            <br />
                            <br />
                            <a class="btn btn-dark text-white col-md-12" href="./messages-frontend.php">Cancelar</a>
                        </form>
                    </div>
                </div>
            </div>
