...
CREATE TABLE `country` (
  ...
  `FormattedName` varchar(80) NOT NULL,
...
INSERT INTO `country` (`CountryId`, `Iso`, `Name`, `FormattedName`, `Iso3`, `NumberCode`, `PhoneCode`) VALUES
...
--
-- Table structure for table `messagefrontend`
--

CREATE TABLE `messagefrontend` (
...
--
-- Table structure for table `messagepublic`
--
...
INSERT INTO `user` (`UserId`, `CountryId`, `Name`, `Username`, `Password`, `Email`, `Admin`, `Active`, `CreationDate`, `Modified`) VALUES
...
--
-- Indexes for table `messagefrontend`
--
ALTER TABLE `messagefrontend`
  ADD PRIMARY KEY (`MessageUserId`),
  ADD KEY `UserId` (`UserId`);

--
-- Indexes for table `messagepublic`
--
...
--
ALTER TABLE `upload`
  MODIFY `UploadId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;

--
-- AUTO_INCREMENT for table `user`
--
ALTER TABLE `user`
  MODIFY `UserId` int(13) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
-- Constraints for table `messagefrontend`
--
ALTER TABLE `messagefrontend`
  ADD CONSTRAINT `messagefrontend_ibfk_1` FOREIGN KEY (`UserId`) REFERENCES `user` (`UserId`);

--
-- Constraints for table `upload`
--
ALTER TABLE `upload`
  ADD CONSTRAINT `upload_ibfk_1` FOREIGN KEY (`UserId`) REFERENCES `user` (`UserId`);
COMMIT;
